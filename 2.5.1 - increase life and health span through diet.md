...
While the recommendations are good, there are some caveats I's like to point out:

- The above recommendations will probably do no harm
- They are most likely incomplete

For example the recommendation to avoid saturated fats is one I expect to be disproven in the coming years of research. The reason for this is that diets rich in saturated fats (think US diet) are often rich in other problematic ingredients like trans fats, sugars and low vegatable ingestion. An early indication for this can be found in a paper that compared cardiovascular disease (CVD), all cause mortality (ACM) for different sources of saturated fat (SFA) consumption[^See [Dietary fat intake and risk of cardiovascular disease and all-cause mortality in a population at high risk of cardiovascular disease](https://www.researchgate.net/publication/283723416_Dietary_fat_intake_and_risk_of_cardiovascular_disease_and_all-cause_mortality_in_a_population_at_high_risk_of_cardiovascular_disease)]:
...
- SFA from dairy showed decreaed ACM for the second lowest consumption, but high risk for high consumers
