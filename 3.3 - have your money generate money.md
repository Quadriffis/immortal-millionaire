...
The reality is that markets go up and down. The biggest danger to any investor is making bad emotional decisions at key moments. Recessions happen every few years pretty reliably. They are hard to impossible to predict, but it is inevitable that you will encounter them. Have a look at the [Wikipedia page for US recessions](https://en.wikipedia.org/wiki/List_of_recessions_in_the_United_States) for a little taste of how common they are.
