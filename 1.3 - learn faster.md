...
Learning is about understanding patterns and connections. Sure you could memorise a sequence like 2-3-5-8-13-21, or you could see the Fibonacci pattern and be able to write down the next hundred numbers of the sequence. Learning is the skill of seeing how everything is connected, and what you can do with that.
...
From [Even Geniuses Work Hard](http://www.ascd.org/publications/educational-leadership/sept10/vol68/num01/Even-Geniuses-Work-Hard.aspx), Carol S. Dweck:
...
I vividly remember my father asking "if glass would have a greater atomic weight, would this glass still stand or would the neck break?" over dinner. To be fair my parents didn't find an answer and ended up in a very frustrated argument that was rather awkward. But regardless of the outcomes of these arguments, I was from a young age conditioned into asking questions.

During high-school me and my friend (hello B) observed that our class was filled with two kinds of students:
...
Since then I've tried to collect as many learning techniques as possible to find ones that suit my learning style. I intend to keep learning my entire life. Formal education has been interesting, but I'm strongly against the idea that after finishing your degree you are done and in some way "complete". Learning is a human need, and I intend to do it as much as I can.
