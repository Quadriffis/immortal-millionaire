...
- How parents have a habit of cripling their children
...
- **Blood vessels follow a pattern similar to tree branches** - Both optimise surface ares. Tree branches form in a way that tries to oprimise the amount of sun its leaves get. You could say that a tree pushes branches away from each other to prevent leaves from growing in the other's shade. Likewise blood vessels optimise surface area to spread oxygen and carbon dioxide. Like leaves the vessels spread away from each other so they don't needlessly compete.
