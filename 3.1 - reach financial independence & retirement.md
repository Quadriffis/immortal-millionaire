...
A little math trick: to get your money tree size based on 4% take your yearly income and multiple it by 25 (the calculation behind that is 1/.04 = 25).
...
| Goal | Book |
| ---- | ---- |
| Passive investing without effort | Unshakable (Tony Robbins) |
...
There are a class of people that calculate their financial goals not on where they live now, but on where they could live. For example, living in Thailand is significantly cheaper than New York City. I suggest calculating this amount based on where you *currently* live. You can always move.
...
Throughout by bitcoin days I failed to reflect on two other pieces of advice I got while in the US. They were very similar suggestions from a guy who everyone called 'doc' and the financial planner of Tim Draper. In short they said to:
