...
![Eisenhower Matrix](./assets/eisenhower-matrix.jpg)

| Important? | Urgent? | Example | Action |
| ---------- | ------- | ------- | ------ |
| No | No | Social Media, 'busywork' | Don't do them or outsource |
| Yes | No | Exercise, friends & family, planning, self-reflection | Schedule in as soon as possible |
| No | Yes | Unproductive meetings, unimportant emails | Delegate or spend as little energy as possible |
| Yes | Yes | Crisis, deadlines | Fix this first |
