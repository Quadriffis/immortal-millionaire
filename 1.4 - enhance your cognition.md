...
To keep your blood sugar within productive levels, the concept of glycemic index (GI) and load (GL) are very important. Both are value assigned to a meal/food to predict the blood sugar spike they will cause. They are at length discussed on the weight loss chapter. For now it is enough to know these generalisations:
